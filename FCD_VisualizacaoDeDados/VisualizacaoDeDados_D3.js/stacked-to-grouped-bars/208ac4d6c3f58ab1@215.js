  ...
  main.variable(observer("viewof layout")).define("viewof layout", ["html"], function(html)
{
  ...
  main.variable(observer("chart")).define("chart", ["d3","DOM","width","height","y01z","z","x","margin","xAxis","y","yMax","n","y1Max"], function(d3,DOM,width,height,y01z,z,x,margin,xAxis,y,yMax,n,y1Max)
{
  ...
  main.variable(observer()).define(["chart","layout"], function(chart,layout){return(
chart.update(layout)
)});
