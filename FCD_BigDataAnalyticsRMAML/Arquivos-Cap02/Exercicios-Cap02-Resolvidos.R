...
# Exercício 4 - Usando a função read.table() leia o arquivo do link abaixo para
# uma dataframe
...
irisSubset = subset(iris, Sepal.Length > 7)
irisSubset

# Exercícios 9 (Desafio) - Crie um dataframe que seja cópia do dataframe iris e
