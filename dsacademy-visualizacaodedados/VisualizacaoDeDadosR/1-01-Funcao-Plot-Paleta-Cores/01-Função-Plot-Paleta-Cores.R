...
setwd("~/Dropbox/DSA/DataViz/Cap06/01-FuncPlot")
# Windows -> setwd("C:/DSA/DataViz/Cap06/01-FuncPlot")
getwd()
...
plot(x,  main = "Título do Plot", col.axis = "blue", col.lab = "red", col.main = "darkblue", xlab = "Mês", ylab = "Vendas")
