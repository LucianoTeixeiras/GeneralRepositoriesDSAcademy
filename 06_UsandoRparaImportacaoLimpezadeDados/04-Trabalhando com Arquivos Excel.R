...
Sys.setenv(JAVA_HOME = '/Library/Java/JavaVirtualMachines/jdk1.8.0_172.jdk/Contents/Home/jre')
Sys.getenv("JAVA_HOME")
system("java -version")
options(java.home = "/Library/Java/JavaVirtualMachines/jdk1.8.0_172.jdk/Contents/Home/jre")
