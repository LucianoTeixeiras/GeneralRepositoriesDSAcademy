...
date1 <- "Jun 13, '18 hours:23 minutes:01 seconds:45"
date1_convert <- as.POSIXct(date1, format = "%B %d, '%y hours:%H minutes:%M seconds:%S")
date1_convert


# Operacoes com Datas
data_de_hoje <- as.Date("2018-06-25", format = "%Y-%m-%d")
data_de_hoje
data_de_hoje + 1

my_time <- as.POSIXct("2018-05-14 11:24:134")
my_time
my_time + 1
...
chegada <- ymd_hms("2018-06-04 12:00:00", tz = "Pacific/Auckland")
...
tm1.lub <- ymd_hms("2018-05-24 23:55:26")
tm1.lub
